    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    Adquiere los nuevos productos que adquirimos este mes, siempre confiando en que sean de tu agrado.
                </p>
            </div>
        </div>
        <div class="row">
        ...
        ?>
                <div class="col-12 col-md-3 p-5 mt-3">
                    <a href="#"><img src="<?php echo BASE_URL . "assets/img/categorias/" .  $categoria["imagen"]; ?>" class="rounded-circle img-fluid border"></a>
        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        Mira toda la cantidad de productos que tenemos para que los adquieras al mejor precio y de calidad asegurada.
                    </p>
                </div>
            </div>
            <div class="row">
            <?php 
                foreach ($data["nuevosProductos"] as $producto) {
            ?>
